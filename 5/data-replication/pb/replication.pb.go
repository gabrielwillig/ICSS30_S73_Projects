...
const file_replication_proto_rawDesc = "" +
	"\n" +
	"\x11replication.proto\x12\vreplication\"\x0f\n" +
	"\rHealthRequest\"*\n" +
	...
	"\x04Read\x12\x18.replication.ReadRequest\x1a\x19.replication.ReadResponse\x12A\n" +
	"\x06Health\x12\x1a.replication.HealthRequest\x1a\x1b.replication.HealthResponse2\xbd\x01\n" +
	"\aReplica\x127\n" +
	"\fReplicateLog\x12\x15.replication.LogEntry\x1a\x10.replication.Ack\x126\n" +
	"\x06Commit\x12\x1a.replication.CommitRequest\x1a\x10.replication.Ack\x12A\n" +
	"\x06Health\x12\x1a.replication.HealthRequest\x1a\x1b.replication.HealthResponseB\x18Z\x16data-replication/pb;pbb\x06proto3"
...
var file_replication_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_replication_proto_goTypes = []any{
	(*HealthRequest)(nil),  // 0: replication.HealthRequest
	(*HealthResponse)(nil), // 1: replication.HealthResponse
	(*WriteRequest)(nil),   // 2: replication.WriteRequest
	(*WriteResponse)(nil),  // 3: replication.WriteResponse
	(*ReadRequest)(nil),    // 4: replication.ReadRequest
	(*ReadResponse)(nil),   // 5: replication.ReadResponse
	(*LogEntry)(nil),       // 6: replication.LogEntry
	(*CommitRequest)(nil),  // 7: replication.CommitRequest
	(*Ack)(nil),            // 8: replication.Ack
}
var file_replication_proto_depIdxs = []int32{
	6, // 0: replication.ReadResponse.entries:type_name -> replication.LogEntry
	2, // 1: replication.Leader.Write:input_type -> replication.WriteRequest
	4, // 2: replication.Leader.Read:input_type -> replication.ReadRequest
	0, // 3: replication.Leader.Health:input_type -> replication.HealthRequest
	6, // 4: replication.Replica.ReplicateLog:input_type -> replication.LogEntry
	7, // 5: replication.Replica.Commit:input_type -> replication.CommitRequest
	0, // 6: replication.Replica.Health:input_type -> replication.HealthRequest
	3, // 7: replication.Leader.Write:output_type -> replication.WriteResponse
	5, // 8: replication.Leader.Read:output_type -> replication.ReadResponse
	1, // 9: replication.Leader.Health:output_type -> replication.HealthResponse
	8, // 10: replication.Replica.ReplicateLog:output_type -> replication.Ack
	8, // 11: replication.Replica.Commit:output_type -> replication.Ack
	1, // 12: replication.Replica.Health:output_type -> replication.HealthResponse
